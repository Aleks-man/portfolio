...
export const content = {
  en: {
    ...
    hero: {
      ...
      title:
        "I build modern websites and web applications with intuitive user interfaces, reliable back-end systems, and attention to detail.",
  ...
  ru: {
    ...
    hero: {
      ...
      title:
        "Создаю современные сайты и веб-приложения с удобным интерфейсом, надежной серверной частью и вниманием к деталям.",
