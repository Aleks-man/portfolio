export const russianContent = {
    ...
    servicesPage: {
      ...
      serviceArea: {
        ...
        title: "Разработка сайтов в Симферополе — для бизнеса в Крыму и по всей России.",
        text: "Нахожусь в Симферополе и работаю с компаниями и специалистами из Крыма. География проекта при этом не ограничена регионом: обсуждение, согласование этапов и передача результата выстроены для дистанционной работы с заказчиками по всей России.",
        services: "Если вам нужно заказать сайт в Симферополе, запустить веб-приложение или развить существующий продукт, можно обратиться за полной разработкой, доработкой, технической поддержкой, backend, API и интеграциями.",
        locationLabel: "Основной регион",
        location: "Симферополь и Республика Крым",
