export const russianContent = {
    ...
    servicesPage: {
      ...
      serviceArea: {
        ...
        services: "Можно обратиться за созданием нового сайта или веб-приложения, доработкой существующего продукта, технической поддержкой, развитием backend, API и интеграций.",
