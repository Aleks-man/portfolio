...
export const russianContent = {
    ...
    hero: {
      eyebrow: "Веб-разработка под ключ",
      title: "Разрабатываю сайты и веб-приложения для бизнеса.",
      lead: "Для компаний, предпринимателей и частных специалистов — от сайта-визитки до полноценного онлайн-сервиса.",
      primaryAction: "Обсудить проект",
      secondaryAction: "Посмотреть проекты",
      responseNote: "На связи — отвечаю в течение рабочего дня",
    ...
    servicesPage: {
      ...
      navigationLabel: "Быстрый переход к услуге",
      deliverables: {
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            answer:
              "Я проверяю проект на основных экранах, помогаю с публикацией и передаю необходимые доступы и инструкции. После запуска два месяца бесплатно сопровождаю проект: слежу за стабильностью его работы и помогаю по техническим вопросам. Новые функции и дальнейшее развитие обсуждаются отдельно.",
          },
          {
